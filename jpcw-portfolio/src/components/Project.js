        ...
        <div className='container'>
            ...
            <div className="card col-12 col-md-4" style={{"max-width": "25rem", "margin-left": "2rem"}}> 
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">While in college at McDaniel College, I was able to put together these really cool images of myself painted in a masterpieces.</p>
            ...
            <div className="card col-12 col-md-4" style={{"max-width": "25rem", "margin-right": "2rem"}}> 
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">I was lucky enough to have the opportunity to work with VAMP, a collective of performing Drag Queens and Ghols based in Tucson, AZ. I created these posters for their Spooky B*tchs Tour. Check out their instagram <a href='https://www.instagram.com/revamped.drag/'>here</a></p>
